...
public class ConfigurationResponseObject {
    /*
    ...
    * {
    ...
    private ImageConfigurationInfo imageConfigurationInfo;

    public String getImageBaseUrl() {
        return imageConfigurationInfo.getSecure_base_url();
    }

    @Override
    public String toString() {
        return "ConfigurationResponseObject{" +
                "imageConfigurationInfo=" + imageConfigurationInfo +
                '}';
    }
}
